...
const Map<String, Map<String, String>> _strings = {
  'es': {
    ...
    'invite_text': '¡Te desafío en BeatBlocks! 🕹️🎵 Entra a mi partida usando este link: {link}',
    'you_win': '¡GANASTE!',
    'you_lose': 'PERDISTE',
  ...
  'en': {
    ...
    'invite_text': 'I challenge you in BeatBlocks! 🕹️🎵 Join my match using this link: {link}',
    'you_win': 'YOU WIN!',
    'you_lose': 'YOU LOSE',
  ...
  'pt': {
    ...
    'invite_text': 'Eu te desafio no BeatBlocks! 🕹️🎵 Entre na minha partida com este link: {link}',
    'you_win': 'VOCÊ VENCEU!',
  ...
  'zh': {
    ...
    'invite_text': '我在 BeatBlocks 向你发起挑战！🕹️🎵 使用此链接加入我的对局：{link}',
    'you_win': '你赢了！',
    'you_lose': '你输了',
    'rival_left': '对手已离开对局',
  },
  'ru': {
    ...
    'invite_text': 'Бросаю тебе вызов в BeatBlocks! 🕹️🎵 Заходи в мой матч по ссылке: {link}',
    'you_win': 'ПОБЕДА!',
    'you_lose': 'ПОРАЖЕНИЕ',
