...
class _MultiplayerScreenState extends State<MultiplayerScreen> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    MultiplayerConnection.instance.onOpponentGameOver = () {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('¡HAS GANADO! El oponente perdió.')));
      }
    };
  }
